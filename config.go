...
type Config struct {
	// Rest api endpoint url. eg: http://www.omex.app/
	Endpoint string

	// Rest websocket api endpoint url. eg: ws://192.168.80.113:10442/
	WSEndpoint string

	// The user's api key provided by OMEx.
	ApiKey string
	// The user's secret key provided by OMEx. The secret key used to sign your request data.
	SecretKey string
