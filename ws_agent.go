...
func (a *OMWSAgent) Start(config *Config) error {
...
func (a *OMWSAgent) Subscribe(channel, filter string, cb ReceivedDataCallback) error {
	a.processMut.Lock()
...
func (a *OMWSAgent) UnSubscribe(channel, filter string) error {
	a.processMut.Lock()
	defer a.processMut.Unlock()
...
func (a *OMWSAgent) Login(apiKey, passphrase string) error {
...
func (a *OMWSAgent) keepalive() {
	a.ping()
}

func (a *OMWSAgent) Stop() error {
	defer func() {
		a := recover()
...
func (a *OMWSAgent) finalize() error {
	defer func() {
...
func (a *OMWSAgent) ping() {
	msg := "ping"
	//log.Printf("Send Msg: %s", msg)
	a.conn.WriteMessage(websocket.TextMessage, []byte(msg))
}

func (a *OMWSAgent) GzipDecode(in []byte) ([]byte, error) {
...
func (a *OMWSAgent) handleErrResponse(r interface{}) error {
	log.Printf("handleErrResponse %+v \n", r)
	return nil
}

func (a *OMWSAgent) handleEventResponse(r interface{}) error {
	er := r.(*WSEventResponse)
	a.activeChannels[er.Channel] = (er.Event == CHNL_EVENT_SUBSCRIBE)
	return nil
}

func (a *OMWSAgent) handleTableResponse(r interface{}) error {
	tb := ""
	switch r.(type) {
