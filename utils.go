...
/*
 Set http request headers:
   ...
   OM-ACCESS-KEY: (Your setting)
   OM-ACCESS-SIGN: (Use your setting, auto sign and add)
   OM-ACCESS-TIMESTAMP: (Auto add)
   OM-ACCESS-PASSPHRASE: Your setting
*/
func Headers(request *http.Request, config Config, timestamp string, sign string) {
	...
	request.Header.Add(OM_ACCESS_KEY, config.ApiKey)
	request.Header.Add(OM_ACCESS_SIGN, sign)
	request.Header.Add(OM_ACCESS_TIMESTAMP, timestamp)
	request.Header.Add(OM_ACCESS_PASSPHRASE, config.Passphrase)
}
