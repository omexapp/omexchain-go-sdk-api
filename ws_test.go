...
/*
 OMEX ws api websocket test & sample
 @author Lingting Fu
 @date 2018-12-27
 @version 1.0.0
*/
...
func TestOMWSAgent_AllInOne(t *testing.T) {
	agent := OMWSAgent{}
...
func TestOMWSAgent_Depths(t *testing.T) {
	agent := OMWSAgent{}
	config := GetDefaultConfig()
...
func TestOMWSAgent_mergeDepths(t *testing.T) {
...
func TestOMWSAgent_calCrc32(t *testing.T) {
...
func TestOMWSAgent_Futures_AllInOne(t *testing.T) {
	agent := OMWSAgent{}
	config := GetDefaultConfig()
...
func TestOMWSAgent_Spots_AllInOne(t *testing.T) {
	agent := OMWSAgent{}
	config := GetDefaultConfig()
	publicChannels := []string{
		CHNL_SPOT_CANDLE60S,
